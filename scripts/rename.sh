...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    find . -not -path './.*' -type f -exec sed -i -e "s,alice/checkers,$MODULE_NAME,g" {} \;
...
mv proto/alice/checkers/* proto/$MODULE_NAME
...
# credits
echo "# This Cosmos SDK module was generated using <https://github.com/alice/checkers>" > THANKS.md
